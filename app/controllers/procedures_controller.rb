class ProceduresController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @procedure.update(procedure_params)
        format.html { redirect_to @procedure, notice: "Procedure was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to procedures_path, notice: "Procedure was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_procedure
      @procedure = Procedure.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def procedure_params
      params.expect(procedure: [ :name, :description, :price ])
    end
end
